...
if __name__ == "__main__":
    ...
    model_file = path_model + "/model/weights.23.hdf5"
    ...
    np.save(path_model + "/predictions/pred1_23.npy", halo_mass_pred1)
    ...
    def plot_violins(p0, t0, p1, t1):
        ...
        fig, ax = pf.compare_two_violin_plots(p0, t0, p1, t1, bins_valid, col1=col1, col2=col2,
                                              ...
                                              label1 ="z=0", label2 = "z=0.5", edge1 = col1, edge2 = col2)
        plt.title("SIM 0: $z=0.5,\, l_{\mathrm{voxel}} = 30 \, \mathrm{kpc}$ (physical)")
