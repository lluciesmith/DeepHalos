...
if __name__ == "__main__":
    ...
    path_model = "/lfstev/deepskies/luisals/regression/z0/highmass/51_3_test"
    ...
    generator_training = gbc.create_generator_multiple_sims(sims, ids_s, output_ids,
                                                            batch_size=len(np.concatenate(output_ids)), dim=(51, 51, 51),
    ...
    generator_1 = gbc.create_generator_sim(ids_1[ran_val], mass_1[ran_val], batch_size=len(ids_1), dim=(51, 51, 51),
                                           rescale_mean=rescale_mean, rescale_std=rescale_std, z=0,
                                           path=ph + "reseed1_simulation/z0_subboxes/")
    X_val1, y_val1 = generator_1[0]
    X_val1_rescaled = (X_val1 - X_mean) / X_std
    ...
    history = Model.model.fit(X_rescaled, y, batch_size=80, verbose=1, epochs=60, validation_data=(X_val1_rescaled, y_val1),
    ...
    generator_1 = gbc.create_generator_sim(ids_1, mass_1, batch_size=len(ids_1), dim=(51, 51, 51),
                                           ...
                                           path=ph + "reseed1_simulation/z0_subboxes/")
    X1, y1 = generator_1[0]
    X_val1_rescaled = (X1 - X_mean) / X_std
