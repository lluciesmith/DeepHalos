...
dim = (75, 75, 75)
params_box = {'input_type': 'potential', 'num_shells': 20}
params_tr = {'batch_size': 64, 'rescale_mean': 0., 'rescale_std': 0.05050, 'dim': dim}
params_val = {'batch_size': 50, 'rescale_mean': 0., 'rescale_std': 0.05050, 'dim': dim}
