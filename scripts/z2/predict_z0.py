...
if __name__ == "__main__":
    ...
    # path_model = "/lfstev/deepskies/luisals/regression/z0/alpha0.03_5sims/"
    ...
    generator_1 = gbc.create_generator_sim(ids_1, mass_1, batch_size=80, dim=(75, 75, 75),
                                           rescale_mean=rescale_mean, rescale_std=rescale_std, z=0,
    ...
    np.save(path_model + "/predictions/pred1_25.npy", halo_mass_pred1)
    np.save(path_model + "/predictions/truth1_25.npy", output_scaler.inverse_transform(mass_1).flatten())
    ...
    #
    #
    #     bins_valid = np.linspace(t1.min(), 14, 13)
    ...
    #                                           label1="sim-0", label2="sim-1", edge1=col1,
    #                                           edge2=col2)
