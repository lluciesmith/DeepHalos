...
generator_training = gbc.create_generator_multiple_sims(sims, ids_s, output_ids, batch_size=100000, dim=(75, 75, 75),
...
generator_1 = gbc.create_generator_sim(ids_1[ran_val], mass_1[ran_val], batch_size=4000, dim=(75, 75, 75),
                                       rescale_mean=rescale_mean, rescale_std=rescale_std, z=0,
                                       path=ph + "reseed1_simulation/z0_subboxes_highmass/")
...
generator_1 = gbc.create_generator_sim(ids_1, mass_1, batch_size=20000, dim=(75, 75, 75),
                                       rescale_mean=rescale_mean, rescale_std=rescale_std, z=0,
                                       path=ph + "reseed1_simulation/z0_subboxes_highmass/")
X1, y1 = generator_1[0]
