...
if __name__ == "__main__":
    ...
    path_model = "/lfstev/deepskies/luisals/regression/z_2.1/4conv/"
    ...
    # training set
    sims = ["3", "4", "5"]
    ids_s = [ids_3, ids_4, ids_5]
    mass_ids = [mass_3, mass_4, mass_5]
...
######### TRAINING MODEL ##############
    ...
    Model = CNN.CNN(generator_training, param_conv, param_fcc,
                    validation_generator=generator_0, validation_freq=1,
                    # metrics=["mae"],
