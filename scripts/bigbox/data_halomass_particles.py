...
if __name__ == "__main__":
    ...
    for sim in sims:
        saving_path = "/mnt/beegfs/work/ati/pearl037/" + sim

        fp = pynbody.load(saving_path + "/snapshots/snapshot_000.hdf5")
        ...
        h = h5py.File(saving_path + "/snapshots/fof_subhalo_tab_000.hdf5", "r")
