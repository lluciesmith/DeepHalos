...
if __name__ == "__main__":
    ...
    saving_path = "/mnt/beegfs/work/ati/pearl037/regression/full_mass_range/200k_random_training/9sims/Xavier" \
                  "/fixed_gamma/smaller_net_glob_avg_bn/"
    ...
    # alpha = 10**(-3.5)
    params_all_conv = {'activation': "linear", 'relu': True, 'strides': 1, 'padding': 'same', 'bn': True,
    ...
    params_all_fcc = {'bn': True, 'activation': "linear", 'relu': True,
    ...
    Model = CNN.CNNCauchy(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                          ...
                          lr=0.0001, save_summary=True, steps_per_epoch=5,
