...
if __name__ == "__main__":
    ...
    saving_path = "/mnt/beegfs/work/ati/pearl037/regression/full_mass_range/200k_random_training/test/"
    ...
    Model = CNN.CNNCauchy(param_conv, param_fcc, lr=0.0001, model_type="regression", shuffle=True,
                      ...
                      max_queue_size=80, use_multiprocessing=True,  workers=40, verbose=1, num_gpu=1,
                      save_summary=True, path_summary=saving_path, seed=seed, initial_epoch=3,
                      compile=True, train=True, load_weights=weights, alpha_mse=10**-4,
