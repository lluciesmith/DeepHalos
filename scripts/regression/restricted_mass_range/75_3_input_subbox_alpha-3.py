...
########### CREATE GENERATORS FOR TRAINING AND VALIDATION #########
    ...
    saving_path = "/mnt/beegfs/work/ati/pearl037/regression/restricted_mass_range/alpha-3/"
    ...
    dim = (75, 75, 75)
    params_tr = {'batch_size': 50, 'rescale_mean': 1.005, 'rescale_std': 0.05050, 'dim': dim}
