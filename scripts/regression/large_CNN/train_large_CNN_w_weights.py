...
if __name__ == "__main__":
    ...
    training_set = tn.InputsPreparation(train_sims, load_ids=True, shuffle=True, weights=True)
    generator_training = tn.DataGenerator(training_set.particle_IDs, training_set.labels_particle_IDS,
                                          s.sims_dic, **params_inputs)

    validation_set = tn.InputsPreparation([val_sim], load_ids=True, random_subset_all=4000, weights=True,
