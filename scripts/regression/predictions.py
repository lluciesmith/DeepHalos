...
validation_set = tn.InputsPreparation(validation_sims, load_ids=True, scaler_output=scaler_output)
...
np.save(path_model + "/predicted1_65.npy", h_m_pred)
np.save(path_model + "/true1_65.npy", true1)
