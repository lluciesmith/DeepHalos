...
model = load_model(path_model + "/models/model_42_epochs_train_sims0345_3epochs_per_sim.h5")
...
pred_0 = model.predict_generator(generator_0)
halo_mass_pred0 = h_mass_scaler.inverse_transform(pred_0).flatten()
np.save(path_model + "/predictions/pred0_epoch42.npy", halo_mass_pred0)
np.save(path_model + "/predictions/truth0.npy", h_mass_scaler.inverse_transform(mass_0).flatten())

pred_2 = model.predict_generator(generator_2)
halo_mass_pred2 = h_mass_scaler.inverse_transform(pred_2).flatten()
np.save(path_model + "/predictions/pred2_epoch42.npy", halo_mass_pred2)
np.save(path_model + "/predictions/truth2.npy", h_mass_scaler.inverse_transform(mass_2).flatten())
