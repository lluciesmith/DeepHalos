...
########### CREATE GENERATORS FOR TRAINING AND VALIDATION #########
    ...
    training_set_particle_IDs = load(open(path_data + 'training_set2.pkl', 'rb'))
    training_set_labels = load(open(path_data + 'labels_training_set2.pkl', 'rb'))
    ...
    generator_training = tn.DataGenerator(training_set_particle_IDs, training_set_labels, s.sims_dic,
