...
if __name__ == "__main__":
    ...
    # tr_labels = np.array([training_labels_particle_IDS[ID] for ID in training_particle_IDs])
    # tr_particle_below_12 = list(np.array(training_particle_IDs)[tr_labels <= 0])
    #
    # val_labels = np.array([val_labels_particle_IDS[ID] for ID in val_particle_IDs])
    # val_particle_below_12 = list(np.array(val_particle_IDs)[val_labels <= 0])
    ...
    # np.save(saving_path + "loss_training_end_epoch_below_12.npy", loss_tr)
