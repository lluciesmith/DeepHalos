...
if __name__ == "__main__":
    ...
    t = np.load(path + "predicted_sim_6_epoch_" + num_epoch + ".npy")
    ...
    f1, (ax11, ax21, ax31) = plot_histogram_predictions(p, t, particle_ids=ids, sim="6", label="DL",
                                                        radius_bins=False, mass_bins=mass_bins_GBT, r_bins=r_bins,
                                                        fig=None, axes=None, color="C0")
    f1, (ax11, ax21, ax31) = plot_histogram_predictions(pred_GBT, truth_GBT, particle_ids=ids, sim="6", label="GBT",
                                                        radius_bins=False, mass_bins=mass_bins_GBT, r_bins=r_bins,
                                                        fig=f1, axes=(ax11, ax21, ax31), color="dimgrey")

    plt.savefig(path + "comparison_w_GBT.png")
    ...
    plt.savefig(path + "predictions_radial_analysis.png")
