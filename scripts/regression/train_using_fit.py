...
Model = CNN.CNN(generator_training, param_conv, model_type="regression", validation_generator=None, num_epochs=5,
                use_multiprocessing=True, workers=12, verbose=1, verbose=1, lr=0.0001, validation_freq=8, train=False,
                skip_connector=True)
