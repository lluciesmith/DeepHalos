...
if __name__ == "__main__":
    ...
    # saving_path = "/share/hypatia/lls/deep_halos/reseed_4/training_set/"
    ...
    # np.savetxt("/share/hypatia/lls/deep_halos/reseed_4/saved_ids_training_set.txt",
    #            np.array(saved_ids), fmt="%i", delimiter=",")

    # Sub-boxes of shape (75, 75, 75)

    saving_path = "/share/hypatia/lls/deep_halos/reseed_4/training_set_res75/"
    sub_in = subb.Subboxes(initial_params, subbox_shape=(75, 75, 75))
    subset_ids = np.loadtxt("/share/hypatia/lls/deep_halos/reseed_4/reseed_4_random_training_set.txt", dtype="int",
                            delimiter=",")
