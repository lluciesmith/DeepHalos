...
if __name__ == "__main__":
    ...
    saving_path = "/share/hypatia/lls/deep_halos/reseed_2/training_set_res75/"
    sub_in = subb.Subboxes(initial_params, subbox_shape=(75, 75, 75))
    subset_ids = np.loadtxt("/share/hypatia/lls/deep_halos/reseed_2/reseed_2_random_training_set.txt", dtype="int",
                            delimiter=",")
