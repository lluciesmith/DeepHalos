...
if __name__ == "__main__":
    ...
    path_data = "/mnt/beegfs/work/ati/pearl037/regression/training_set/9sims/uniform/4k_perbin/"
    ...
    print("Training set has length:")
    print(len(training_particle_IDs))
    print("Validation set has length:")
    print(len(val_particle_IDs))
    ...
    Model = CNN.CNNCauchy(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                          ...
                          dim=generator_training.dim, max_queue_size=80, use_multiprocessing=True, workers=40,
                          verbose=1, num_gpu=1, lr=0.0001, save_summary=True, path_summary=saving_path,
                          validation_freq=1, train=True, compile=True, initial_epoch=None, seed=seed)
