...
if __name__ == "__main__":
    ...
    path_model = "/lfstev/deepskies/luisals/regression/large_CNN/relu_minmax/"
    ...
    training_set = tn.InputsPreparation(train_sims, load_ids=True, shuffle=True, scaler_type="minmax")
