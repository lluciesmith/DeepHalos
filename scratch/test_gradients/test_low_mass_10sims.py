...
########### CREATE GENERATORS FOR TRAINING AND VALIDATION #########
    ...
    path_model = "/lfstev/deepskies/luisals/regression/large_CNN/test_lowmass/reg_100000_perbin/"
    ...
    training_set = tn.InputsPreparation(train_sims, load_ids=False, shuffle=True, scaler_type="minmax",
                                        ...
                                        random_style="uniform", random_subset_each_sim=1000000, num_per_mass_bin=100000,
