...
if __name__ == "__main__":
    ...
    Model = CNN.CNN(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                    ...
                    max_queue_size=1, use_multiprocessing=False, workers=0, verbose=1, num_gpu=1, lr=0.0001,
                    loss=lf.cauchy_selection_loss_fixed_boundary(gamma=1.), save_summary=True, path_summary=path_model,
