...
if __name__ == "__main__":
    ...
    M = CNN.CNN(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                metrics=['mae', 'mse'], num_epochs=11, dim=generator_training.dim, max_queue_size=1,
                use_multiprocessing=False, workers=0, verbose=1, num_gpu=1, lr=0.0001, loss='mse', save_summary=False,
                validation_freq=1, train=False, compile=True, initial_epoch=10)
    ...
    predictions = CNN.LossTrainableParams()(model_mse.layers[-1].output)
    ...
    history = trained_model.fit_generator(generator=generator_training,
                                          ...
                                          use_multiprocessing=False, workers=0, max_queue_size=10, verbose=1,
