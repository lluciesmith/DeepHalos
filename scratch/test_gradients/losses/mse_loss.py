...
if __name__ == "__main__":
    ...
    Model = CNN.CNN(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                    ...
                    num_epochs=100, dim=generator_validation.dim, max_queue_size=10, use_multiprocessing=True,
                    workers=2, verbose=1, num_gpu=1, lr=0.001, loss=loss, save_summary=True, path_summary=path_model,
                    validation_freq=1, train=True, validation_steps=len(generator_validation))
