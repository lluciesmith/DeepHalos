...
if __name__ == "__main__":
    ...
    path_model = "/lfstev/deepskies/luisals/regression/large_CNN/selu/"
    ...
    param_fcc = {'dense_1': {'neurons': 256, 'bn': False, 'alpha_dropout': 0.4, 'activation': activation, 'relu': relu,
                             'kernel_regularizer': kernel_reg, 'bias_regularizer': bias_reg},
                 'dense_2': {'neurons': 128, 'bn': False, 'alpha_dropout': 0.4, 'activation': activation, 'relu': relu,
                             'kernel_regularizer': kernel_reg, 'bias_regularizer': bias_reg},
    ...
    Model = CNN.CNN(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                    ...
                    num_epochs=100, dim=params_inputs['dim'], initialiser=initialiser, max_queue_size=10,
                    use_multiprocessing=True, workers=2, verbose=1, num_gpu=1, lr=0.001, save_summary=True,
                    path_summary=path_model, validation_freq=1, train=True)
