...
if __name__ == "__main__":
    ...
    path_model = "/lfstev/deepskies/luisals/regression/large_CNN/weighted/"
    ...
    training_set = tn.InputsPreparation(train_sims, load_ids=True, shuffle=True, scaler_type="minmax", weights=True)
    ...
    validation_set = tn.InputsPreparation([val_sim], load_ids=True, random_subset_all=4000,
                                          scaler_output=training_set.scaler_output, shuffle=True, weights=True)
    ...
    Model = CNN.CNN(param_conv, param_fcc, model_type="regression", training_generator=generator_training,
                    ...
                    verbose=1, num_gpu=1, lr=0.001, save_summary=True, path_summary=path_model, validation_freq=1,
                    train=True)
